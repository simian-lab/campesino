    ...
    $.ias = function (options)
    {
        ...
        function paginate(curScrOffset, onCompleteHandler)
        {
            ...
            loadItems(urlNextPage, function (data, items) {
                ...
                // update pagination
                //console.log($(opts.pagination, data));
                $(opts.pagination).replaceWith($(opts.pagination, data));
               // $(".navigation .next-posts a").attr('href', $(".navigation .next-posts a").attr('href').substr(0, $(".navigation .next-posts a").attr('href').length-1)+(parseInt($(".navigation .next-posts a").attr('href').split('/')[4])+1))
