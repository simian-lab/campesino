...
switch ($_SERVER['SERVER_NAME'])
{
	...
	case 'origin-www2.cyberlunes.com.co':	 
		$dominiosPermitidos=array('static-stage.cyberlunes.com','static.cyberlunes.com.co','http://d3b369zdeuh99v.cloudfront.net/' );
	break;
...
$PHPTHUMB_CONFIG['error_message_image_default'] = '/multimedia/blankerror.jpg';       // Set this to the name of a generic error image (e.g. '/images/error.png') that you want displayed in place of any error message that may occur. This setting is overridden by the 'err' parameter, which does the same thing.
...
$PHPTHUMB_CONFIG['error_fontsize']              = 4;        // size of text in error messages, from 1 (smallest) to 5 (largest)
...
$PHPTHUMB_CONFIG['nooffsitelink_valid_domains'] = $dominiosPermitidos;              // This is the list of domains for which thumbnails are allowed to be created. The default value of the current domain should be fine in most cases, but if neccesary you can add more domains in here, in the format 'www.example.com'
