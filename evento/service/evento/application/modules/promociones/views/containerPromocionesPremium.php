                ...
                ?>
                    <li class="<?php echo $li_class; ?> post col-lg-6 col-md-6 col-sm-6 col-sx-12" data-id="<?php echo $promocion['PRO_ID'] ?>">
                        <figure>
                            ...
                            <div class="overlay">
                                ...
                                <?php                                    
                                   ...
                                   echo get_url_promocion($promocion['PRO_URL'], 'ir a oferta',0, array($posicion, $promocion['PRO_USER_CREADOR'], $promocion['PRO_ID']));
                                ?>
                            ...
                            <a onClick="onClickOferta('<?php echo $promocion['PRO_ID'] ?>', '<?php echo $posicion ?>')" style="display: block;" target="_blank" href="<?php echo get_url_encrypt($promocion['PRO_URL']) ?>"><img src="<?php echo ($base_url_img_promociones . $promocion['PRO_LOGO_PREMIUM']); ?>" alt="<?php echo character_limiter(strip_tags($promocion['PRO_DESCRIPCION']), 50); ?>" title="<?php echo strip_tags($promocion['PRO_NOMBRE']); ?>"></a>
                        ...
                        <article>
                            ...
                            <?php endif; ?>
                              <?php                                    
                                   echo get_url_promocion($promocion['PRO_URL'], 'ir a oferta');
                              ?>
