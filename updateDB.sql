...
ADD COLUMN `EVE_TITLE` VARCHAR(150) NULL COMMENT '' AFTER `EVE_PREFIJO`,
ADD COLUMN `EVE_META_DESCRIPTION` VARCHAR(150) NULL COMMENT '' AFTER `EVE_TITLE`,
ADD COLUMN `EVE_FACEBOOK` VARCHAR(150) NULL COMMENT '' AFTER `EVE_META_DESCRIPTIO`,
ADD COLUMN `EVE_TWITTER` VARCHAR(150) NULL COMMENT '' AFTER `EVE_FACEBOOK`,
ADD COLUMN `EVE_TAG_LINE` VARCHAR(150) NULL COMMENT '' AFTER `EVE_TIWTER`;
