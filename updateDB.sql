...
COUNT(IF(PRO_PROMOCIONES.PRO_SRC_ID = 3, PRO_PROMOCIONES.PRO_SRC_ID, NULL)) AS PAQ_CREADAS_PREMIUM,
PAQUETES_NOMBRES.PAQ_MONTO_PREMIUN_CATEGORIA AS PAQ_MONTO_PREMIUM_CATEGORIA,
COUNT(IF(PRO_PROMOCIONES.PRO_SRC_ID = 2, PRO_PROMOCIONES.PRO_SRC_ID, NULL)) AS PAQ_CREADAS_PREMIUM_CATEGORIA,
PAQUETES_NOMBRES.PAQ_MONTO_BASICO AS PAQ_MONTO_GENERAL,
COUNT(IF(PRO_PROMOCIONES.PRO_SRC_ID = 1, PRO_PROMOCIONES.PRO_SRC_ID, NULL)) AS PAQ_CREADAS_GENERAL
