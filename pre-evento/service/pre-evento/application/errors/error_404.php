...
switch ($_SERVER['SERVER_NAME']){
    case 'pre-evento.cyberlunes.local':  
        $base_url = 'http://pre-evento.cyberlunes.local/';
        $base_url_static = 'http://pre-evento.cyberlunes.local/static/pre-evento/'; 
    break;
   ...
   case 'cyberlunes.loencontraste.com':    
        $base_url = 'http://cyberlunes.loencontraste.com/';
        $base_url_static = 'http://cyberlunes.loencontraste.com/static/pre-evento/'; 
    break;
