            ...
            <div class="container">
                <div class="row head">
                    ...
                    <div class="col-md-6 marcas">
                        <figure>
                            <a href="https://www.bbva.com.co/web/personas/tarjetas" target="_blank" onclick="onClickPublicidad('BBVA', 'Header')"><img src="<?php echo $base_url_static;?>img/BBVA_87X35.png" alt="Grupo Aval" /></a>
                        </figure>
                        <figure>
