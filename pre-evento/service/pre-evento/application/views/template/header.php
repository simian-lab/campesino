            ...
            <div class="container">
                <div class="row head">
                    ...
                    <div class="col-md-6 marcas">
                        <figure>
                            <a href="https://www.grupoaval.com" target="_blank" onclick="onClickPublicidad('Grupo Aval', 'Header')"><img src="<?php echo $base_url_static;?>img/grupo_aval_desk.png" alt="Grupo Aval" /></a>
                        </figure>
                        <figure>
                        ...
                        <figure>
                            <a href="http://www.vivedigital.gov.co" target="_blank" onclick="onClickPublicidad('Vive digital', 'Header')"><img src="<?php echo $base_url_static;?>img/viveDigital.png" alt="Vive digital" /></a>
                        </figure>
                        <figure>
                            <a href="http://wsp.presidencia.gov.co" target="_blank" onclick="onClickPublicidad('Gobierno de Colombia', 'Header')"><img src="<?php echo $base_url_static;?>img/nuevoPais.png" alt="Gobierno de Colombia" /></a>
                        </figure>
                    </div>
                </div>                             
            </div>            
