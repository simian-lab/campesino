    ...
    <div class="container">
        ...
        <div class="slider">
            ...
            <div class="countDown">
                ...
                <script>
                    var date = new Date(Date.UTC(2014,04,19)); 
                ...
                <section>
                    <form action="http://www.elabs10.com/functions/mailing_list.html" method="post" name="UPTml251011" onSubmit='s.linkTrackVars="events,eVar38"; s.linkTrackEvents="event5"; s.eVar38="header";s.events="event5";s.tl(true,"o","Formulario Registro"); return (!(UPTvalidateform(document.UPTml251011)));'>
                        ...
                        <div class="bases">
                            ...
                            <span>Acepto los <a href="#" data-toggle="modal" data-target="#terminos">términos y condiciones</a> y la <a href="#" data-toggle="modal" data-target="#politicas">política de privacidad</a> del portal.</span>           
                        </div> 
                        <!--<div class="bases">
