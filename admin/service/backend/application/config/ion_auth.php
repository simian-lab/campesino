...
$config['collections']['users']          = $pref.'users';
$config['collections']['groups']         = $pref.'groups';
$config['collections']['login_attempts'] = $pref.'login_attempts';
...
*/
$config['tables']['users']           = $pref.'users';
$config['tables']['groups']          = $pref.'groups';
$config['tables']['users_groups']    = $pref.'users_groups';
$config['tables']['login_attempts']  = $pref.'login_attempts';
$config['tables']['process']  		 = $pref.'process';
$config['tables']['process_groups']  = $pref.'process_groups';
 ...
 */
$config['site_title']           = "Brandigital"; 		// Site Title, example.com
$config['admin_email']          = "no-reply@cyberlunes.com.co"; 	// Admin Email, admin@example.com
