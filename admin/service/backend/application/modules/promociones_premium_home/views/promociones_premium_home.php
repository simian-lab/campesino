...
// $("#PRO_URL_field_box").append("<a href='javascript:;' id='open'>Vista previa</a>");
  ...
  /*$('#pruebavistaprevia').click(function(){
    ...
    $.ajax({
      type: 'POST',
      url: '<?php echo base_url('index.php/main/vista_previa_promociones') ?>',
      data: {nombre: nombre_promocion, descripcion: descripcion_promocion, precio_inicial: precio_inicial_promocion, precio_final: precio_final_promocion, descuento: descuento_promocion, url: url_promocion, imagen_premium: nombre_imagen_promocion_premium, seccion: 'premium_home'},
      success: function(data){
        newWin.document.write(data);
      }
    });
