...
/*		$this->image_moo
			->load($path)
			->resize_crop(100,400)
			->save_dynamic($path,true);*/

        		$this->image_moo->load($path)->resize_crop($this->width,$this->height)->save($path,true);

			//	$this->image_moo->load($path)->resize_crop($this->width,$this->height)->save_dynamic($path,true);
		
//			$this->image_moo->load($path)->resize($this->width,$this->height)->save($path,true);
